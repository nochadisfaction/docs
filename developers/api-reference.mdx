...
[Getting Started](getting-started.mdx) for setup.
    ...
    **Response** (200):
    ...
    ```json
    {
      ...
      "feedback": {
        ...
        "improvements": [
          "Missed indirect crisis signal at message 4",
          "Redirected before fully validating at message 7"
        ],
        "emotionalTimeline": [
...
<CardGroup cols={3}>
  ...
  <Card title="Getting Started" icon="rocket" href="getting-started.mdx">
    Local setup.
  </Card>
  <Card
    title="Platform Overview"
    icon="circle-info"
    href="../platform/overview.mdx"
  >
    How it all works.
  </Card>
</CardGroup>
