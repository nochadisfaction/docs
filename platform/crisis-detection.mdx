...
<AccordionGroup>
  ...
  <Accordion title="Cultural Context" icon="globe">
    ...
    Learn more:
    [Cultural Empathy](../knowledge/cultural-empathy.mdx)
  ...
  <Accordion title="Privacy" icon="lock">
    ...
    Learn more:
    [Privacy & Trust](privacy-and-trust.mdx)
...
<CardGroup cols={3}>
  <Card
    ...
    icon="heart-pulse"
    href="../knowledge/when-someone-is-in-crisis.mdx"
  >
  ...
  <Card
    ...
    icon="scale-balanced"
    href="../research/ethical-ai-framework.mdx"
  >
